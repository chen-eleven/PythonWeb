# Generated by Django 2.2.3 on 2019-08-01 11:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clo_name', models.CharField(default=None, max_length=20, verbose_name='列名')),
                ('field_type', models.CharField(default=None, max_length=10, verbose_name='字段类型')),
                ('level', models.SmallIntegerField(default=0, verbose_name='字段等级,默认0普通')),
                ('comment', models.CharField(default=None, max_length=128, verbose_name='表的简介')),
