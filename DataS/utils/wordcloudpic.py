...
back_color = imread('tmp_3.jpg')  # 解析该图片
...
# 打开词源的文本文件
text = open('chapter15/out/1111/reshuiqi.txt', encoding="utf-8").read()
...
def stop_words(texts):
    ...
    with open('chapter15/out/1111/stoplist.txt', encoding="utf-8") as f:
        str_text = f.read()
        unicode_text = str_text       #unicode(str_text, 'utf-8')  # 把str格式转成unicode格式
